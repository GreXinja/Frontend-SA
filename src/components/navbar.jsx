        ...
        <nav className="flex gap-6 font-medium items-center">
          ...
          {isLoggedIn && (
            <>
              ...
              <Link to="/insights/soil" className="hover:text-green-700">Soil</Link>
              <Link to="/insights/solar" className="hover:text-green-700">Solar</Link>
              <Link to="/insights/crop" className="hover:text-green-700">Crop</Link>
            </>
          )}
